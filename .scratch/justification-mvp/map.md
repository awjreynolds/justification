...
- The user subsequently requested TDD. Use one behavioral test and minimum implementation per red–green cycle; agree test seams before writing tests. [TDD proposal](../../docs/planning/tdd-plan.md) records the proposed runtime, CLI and MCP seams and their pending confirmation. This request does not by itself resolve the open design tickets.
