...
This review verifies selected primary sections, not standards conformance. QOC coverage uses its author-deposited abstract; IBIS concepts were checked against a transcription of the original paper; its institutional PDF is linked for primary-source access. No implementation or performance experiment was conducted.
