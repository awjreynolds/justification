...
| 17: MCP | Actual SDK stdio clients and installed Codex; two configured projects, structured errors, restart and full ADR workflow | Legacy and current SDK lifecycles pass, including maintenance, foreign-node isolation and cache rebuild; installed Codex production calls pass; final integration review in progress |
